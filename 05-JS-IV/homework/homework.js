...
function sumarLikesDeUsuario(usuario) {
  ...
  // Tu código:
  var aux = 0;
  for (var cont in usuario.posts) {
    aux = aux + usuario.posts[cont].likes;
  }
  return aux;

  //Creo que en la explicacion de post, es muy confuso. Habia entendido que en cada array estaba un objeto llamado posts.
}
